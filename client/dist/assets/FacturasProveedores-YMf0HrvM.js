import{r as n,j as e,I as K,U as Ce,V as De,b5 as C,ad as $,ae as V,a7 as L,b6 as Ne,X as ke,ay as Se,a$ as Ae,aJ as Fe,ag as Pe,k as O,a as Ee,q as s,ac as G,s as ae,T as _e}from"./vendor-Dp7SZ6lv.js";import{u as $e,F as Te,G as ze,H as Ie,I as Be,J as Me}from"./index-CRUdEL4u.js";import"./scanner-vendor-DfxRpMWJ.js";import"./pdf-vendor-DjsH35t9.js";const Q=()=>new Date().toLocaleDateString("sv-SE",{timeZone:"America/Managua"}),ee=a=>{if(!a)return"—";const u=new Date(a.includes("T")?a:`${a}T12:00:00`);return new Intl.DateTimeFormat("es-NI",{timeZone:"America/Managua",day:"2-digit",month:"2-digit",year:"numeric"}).format(u)},te=ae`from { opacity: 0; transform: translateY(10px); } to { opacity: 1; transform: translateY(0); }`,Re=ae`from { transform: scale(0.95); opacity: 0; } to { transform: scale(1); opacity: 1; }`,Ve=s.div`
