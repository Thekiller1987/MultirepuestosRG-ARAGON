import{r as n,j as e,J as K,V as Ce,W as De,b6 as C,ae as $,af as V,a8 as L,b7 as Ne,Y as ke,az as Se,b0 as Ae,aK as Fe,ah as Pe,n as O,b as Ee,s,ad as G,t as ae,U as _e}from"./vendor-BJZlzDLx.js";import{u as $e,F as ze,G as Te,H as Ie,I as Be,J as Me}from"./index-eefq-jxX.js";import"./scanner-vendor-DfxRpMWJ.js";import"./pdf-vendor-BoQlG7Vl.js";const Q=()=>new Date().toLocaleDateString("sv-SE",{timeZone:"America/Managua"}),ee=a=>{if(!a)return"—";const u=new Date(a.includes("T")?a:`${a}T12:00:00`);return new Intl.DateTimeFormat("es-NI",{timeZone:"America/Managua",day:"2-digit",month:"2-digit",year:"numeric"}).format(u)},te=ae`from { opacity: 0; transform: translateY(10px); } to { opacity: 1; transform: translateY(0); }`,Re=ae`from { transform: scale(0.95); opacity: 0; } to { transform: scale(1); opacity: 1; }`,Ve=s.div`
