import{R as U,r as l,j as e,k as st,I as lt,a7 as dt,C as ct,q as x,t as pt,w as De,aJ as mt,y as xt,p as ht,ac as le,aT as ft,aF as Be,g as qe,aU as Ke,aV as gt,J as ut,aA as Xe,aB as et,ag as bt,W as We,X as jt,Q as yt,aW as Ct,aX as vt,aY as Nt,aZ as tt,a_ as He,ae as $e}from"./vendor-Dp7SZ6lv.js";import{c as Ne,d as we,B as T,T as G,I as ke,S as be}from"./POS.styles-D5dfWbaN.js";import{u as Ee,y as wt,i as kt,a as $t}from"./index-CRUdEL4u.js";import{A as St}from"./AlertModal-BThKNu9Y.js";const Tt=x.div`
...
`,oe=t=>new Intl.NumberFormat("es-NI",{minimumFractionDigits:2,maximumFractionDigits:2}).format(Number(t||0)),S=(...t)=>t.find(n=>n!=null),re=t=>S(t==null?void 0:t.usuarioNombre,t==null?void 0:t.nombre_usuario,t==null?void 0:t.nombre,t==null?void 0:t.name,t==null?void 0:t.displayName,t==null?void 0:t.fullName,t==null?void 0:t.username,null);function Gt(t=[]){return t.map((n,p)=>{const m=Number(S(n.quantity,n.cantidad,n.qty,0)),y=S(n.nombre,n.descripcion,n.description,n.producto,`Item ${p+1}`),u=Number(S(n.precio_unitario,n.precio_venta,n.precio,n.unitPrice,0));return{id:S(n.id_producto,n.id,`it-${p}`),nombre:y,quantity:m,unit:u,total:m*u}})}function Zt(t={}){const n=Number(t.efectivo||0),p=Number(t.tarjeta||0),m=Number(t.transferencia||0),y=Number(t.dolares||0);if(Number(t.credito||0)>0)return"Crédito";const s=[];return n>0&&s.push("Efectivo"),p>0&&s.push("Tarjeta"),m>0&&s.push("Transferencia"),y>0&&s.push("Dólares"),s.length===0?"Contado":s.length===1?s[0]:"Mixto"}function Jt(t={},n=0){const p=Number(t.efectivo||0),m=Number(t.tarjeta||0),y=Number(t.transferencia||0),u=Number(t.otro||0),s=Number(t.dolares||0),v=Number(t.tasaDolarAlMomento||t.tasaObtenida||1),h=s*(v>1?v:1),i=p+m+y+u+h;return i>0?i:Number(t.montoRecibido||n||0)}function Qt(t){const n=S(t==null?void 0:t.fecha,t==null?void 0:t.createdAt,t==null?void 0:t.created_at,t==null?void 0:t.date,t);try{const p=new Date(n);return isNaN(p)?"Fecha inválida":p.toLocaleString("es-NI",{hour12:!0})}catch{return"Fecha inválida"}}function Yt(t){const n=S(t.proformaId,t.proformaNumero,t.numeroProforma,t.id);if(n)return n;const p=new Date,m=p.toISOString().slice(2,10).replace(/-/g,""),y=p.toTimeString().slice(0,8).replace(/:/g,"");return`PF-${m}-${y}`}const wn=({transaction:t,onClose:n,clients:p=[],users:m=[],isOpen:y=!0,printMode:u="80",currentUser:s=null,onPersistPrint:v=null})=>{var Q;const{user:h}=typeof Ee=="function"?Ee():{user:null},{settings:i}=$t();if(!y||t==null)return null;const[w]=U.useState(typeof t=="object"?t:null),[E]=U.useState(!1),[A]=U.useState(null);if(E||A||!w)return e.jsx(Ne,{className:"no-print",children:e.jsxs(we,{className:"no-print",style:{maxWidth:420,padding:"1rem"},children:[e.jsx("h3",{style:{color:"#dc3545"},children:"No se pudo imprimir"}),e.jsx("div",{style:{display:"flex",justifyContent:"center",marginTop:12},children:e.jsxs(T,{onClick:n,$cancel:!0,children:[e.jsx(De,{})," Cerrar"]})})]})});const a=w,k=a.estado==="ABONO_CREDITO",f=!!(a.isProforma||a.proformaFor||a.proformaNombre),I=!!a.isOutflow,H=a.estado==="DEVOLUCION",g=f?Yt(a):S(a.id,a.saleId,a.numero,"-"),$=Qt(S(a.fecha,a.createdAt,a.date)),C=S(a.clientId,a.idCliente,a.clienteId),D=p.find(b=>String(b.id_cliente??b.id)===String(C)),O=f&&a.proformaNombre?a.proformaNombre:S(D==null?void 0:D.nombre,a.clienteNombre,"Consumidor Final"),q=(D==null?void 0:D.cedula)||a.clienteCedula,X=S(a.userId,a.idUsuario,(Q=a.openedBy)==null?void 0:Q.id)??(s==null?void 0:s.id_usuario)??(s==null?void 0:s.id)??(s==null?void 0:s.uid)??(h==null?void 0:h.id_usuario)??(h==null?void 0:h.id)??(h==null?void 0:h.uid),F=(()=>{try{return JSON.parse(localStorage.getItem("authUser")||"null")}catch{return null}})(),ee=m.find(b=>String(b.id_usuario||b.id||b.uid)===String(X)),Z=S(a.usuarioNombre,re(ee),re(s),re(h),re(F),"Cajero POS"),L=f?S(a.usuarioNombre,re(s),re(h),re(F),Z):Z,r=Gt(S(a.items,a.detalle,[])),d=r.reduce((b,Y)=>b+Number(Y.unit)*Number(Y.quantity),0),N=Number(S(a.subtotal,d)),R=Number(S(a.descuento,0)),M=Number(S(a.totalVenta,a.total_venta,N-R,0)),J=a.pagoDetalles||{},_=f||I?"N/A":S(a.metodoPago,Zt(J)),me=f||I?0:Jt(J,M),te=f||I?0:Math.max(0,me-M);Math.abs(Number(S(a.totalVenta,a.montoAbono,0))),Number((D==null?void 0:D.saldo_pendiente)||0);const ne=r.length<=2,P={name:(i==null?void 0:i.empresa_nombre)||"Multirepuestos RG",ruc:(i==null?void 0:i.empresa_ruc)||"1211812770001E",phone:(i==null?void 0:i.empresa_telefono)||"84031936 / 84058142",address:(i==null?void 0:i.empresa_direccion)||"Del portón de la normal 75 varas al este. Juigalpa, Chontales.",slogan:(i==null?void 0:i.empresa_eslogan)||"Repuestos de confianza al mejor precio",logo:i!=null&&i.empresa_logo_url?(i.empresa_logo_url.startsWith("http"),i.empresa_logo_url):new URL("/icons/logo.png",window.location.origin).toString()};U.useCallback(async b=>{},[]);const ae=U.useCallback((b="80")=>{const Y=document.getElementById("print-wrapper-ticket");if(!Y)return;const de=Y.outerHTML,ie=`
      @charset "UTF-8";
